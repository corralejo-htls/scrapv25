-- =============================================================================
-- BookingScraper Pro — Schema Completo v6.0.0 build 109
...
-- =============================================================================
-- VISTA v_api_export_images (Build 109)
...
-- del payload de la API. Prioriza highres_url > large_url > thumb_url por foto.
-- =============================================================================
...
COMMENT ON VIEW v_api_export_images IS
    'Build 109: fotos visibles en galería (image_data.gallery_visible=TRUE) con sus descargas completadas, ordenadas por gallery_order — fuente para images[] de la API.';
