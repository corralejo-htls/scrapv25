...
COMMENT ON VIEW v_hotels_full IS
    'Vista denormalizada de hotel con description, fine_print, highlights (jsonb array de {category,detail}), amenities, '
    'all_services, faqs, popular_services, policies, guest_reviews, legal (con has_legal_content) y url_queue data (v60)';
...
-- v55: BUG-EXTR-010 corregido en extractor.py, FIX-LEGAL-003 en extractor.py
