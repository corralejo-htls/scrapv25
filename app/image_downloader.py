...
CORRECCIONES v1.2:
  [FIX CRITICO] download_images() acepta session=requests.Session opcional.
               Sin sesion autenticada, bstatic.com CDN bloquea las descargas
               con HTTP 403. Al pasar la sesion con cookies de Brave, las
               imagenes se descargan correctamente como si fuera el browser.
...
CORRECCIONES v1.3:
  [FIX] Filtro de dimensiones minimas: descarta imagenes < 200x150 px.
        Elimina iconos 24x24, avatares 128x128 y pixeles tracking 1x1
        que pudieran escapar al filtro del extractor.
...
class ImageDownloader:
    ...
    def download_images(
        ...
        Args:
            ...
            language:   Subdirectorio por idioma.
        ...
        logger.info(f"📷 Descargando {len(image_urls)} imágenes | hotel={hotel_id} lang={language}")
