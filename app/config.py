...
class Settings(BaseSettings):
    ...
    # [FIX] Países en inglés al inicio (US, UK, CA). ES movido al final para evitar que
    # Booking.com sirva contenido en español al detectar IP española durante scraping "en".
    VPN_COUNTRIES: List[str] = ["US", "UK", "CA", "DE", "FR", "NL", "IT", "ES"]
    ...
    # [FIX] LANGUAGE_EXT: 'en' sin sufijo = URL base (booking.com usa ?lang=en-us vía parámetro)
    LANGUAGE_EXT: dict = {
        "en": "",
        "es": ".es",
        "fr": ".fr",
