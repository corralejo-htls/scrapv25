# app/config.py — BookingScraper Pro v6.0.0 Build 104
# BUILD 104 — BUG-CAT-SPACE-001-FIX: extractor.py _normalize_category_heading()
# =============================================================================
...
class Settings(BaseSettings):
    ...
    # ==========================================================================
    # ── Languages — Single source of truth: languages.json (Build 98) ─────────
    # ==========================================================================
