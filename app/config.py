# app/config.py — BookingScraper Pro v6.0.0 Build 125
...
class Settings(BaseSettings):
    ...
    SCRAPER_MAX_WORKERS: int = Field(
        ...
        description="Number of parallel URL workers (ThreadPoolExecutor). "
                    "Note: SeleniumEngine uses a single threading.Lock(), so "
                    "browser operations are always serialized regardless of this "
                    "value. Effective concurrency = 1 URL at a time.",
    )
