"""
config.py — BookingScraper Pro v48
...
class Settings(BaseSettings):
    ...
    VPN_ROTATION_INTERVAL: int = Field(default=300, ge=60, le=3600)
    ...
    def settings_customise_sources(
        ...
        """
        Replace the default DotEnvSettingsSource with our comma-aware version.
        This is the correct interception point — it runs before pydantic validation.
        """
        return (
            init_settings,
            env_settings,
            _CommaAwareDotEnvSource(settings_cls, dotenv_settings.env_file),
        )
