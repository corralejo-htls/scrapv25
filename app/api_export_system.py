"""
api_export_system.py — BookingScraper Pro v6.0.0 Build 112
==========================================================

BUG-ONLYTITLE-001-FIX (Build 112):
    ExportTemplate.args_config default tenía "onlyTitle": True. Este valor
    es el que _filter_payload() usa para construir la sección "args" del
    payload final enviado por APIExporter. Todos los hoteles exportados en
    producción recibían onlyTitle=True, lo que significa que solo
    name/longDescription eran procesados por la API externa aunque el payload
    completo (21 campos) estuviese presente. Fix: default cambiado a False
    (exportación completa). Los operadores con plantillas JSON guardadas con
    "onlyTitle": true las mantienen sin cambios. Para pruebas de conexión
    API se puede forzar True via API_EXPORT_ONLY_TITLE=true en .env.
...
class ExportTemplate:
    ...
    args_config: Dict[str, Any] = field(default_factory=lambda: {
        "seoFormatKey": "",
        "onlyTitle": False,   # BUG-ONLYTITLE-001-FIX (Build 112): era True — silenciaba 20 campos
        "regenerateSeo": True,
        "append": False,
        "cache": True,
    })
