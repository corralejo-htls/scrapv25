...
-- Version: v40 (Enterprise Audit v40 — All Critical Issues Fixed 2026-03-06)
--
-- PURPOSE:
...
-- [FIX MED-40-006] \connect is a psql-only meta-command. It is NOT valid SQL
-- and fails silently in pgAdmin, DBeaver, DataGrip, and Python DB-API clients.
-- REMOVED: \connect booking_scraper
--
...
--   pgAdmin / DBeaver:
--     Step 1: Run only Section 1 (CREATE DATABASE) connected to the 'postgres' database.
--     Step 2: Reconnect to 'booking_scraper' database.
--     Step 3: Run the remainder of this script (Sections 2-10).
--
-- If running via Python psycopg3:
--     Use two separate connections: one for CREATE DATABASE, one for the schema.
