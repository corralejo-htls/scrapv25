...
class HotelNearbyPlace(Base):
    ...
    Estructura (BIGSERIAL, muchas filas por hotel/lang):
      ...
      category   — categoría del ícono (e.g. "airport", "restaurant")
    """
    ...
    category: Mapped[Optional[str]] = mapped_column(
        ...
        comment="Categoría del ícono de Booking.com (e.g. 'airport', 'restaurant')"
    )
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False, default=_utcnow
    )
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"place={self.place_name!r} dist={self.distance!r}>"
        )
