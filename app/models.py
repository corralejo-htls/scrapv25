"""
models.py — BookingScraper Pro v6.0.0 build 51
===============================================
Cambios estructurales v51:

  STRUCT-005 : HotelAmenity — nueva tabla hotels_amenities.
               hotels.amenities (JSONB) eliminado.
               Cada amenidad es un registro independiente con (hotel_id, url_id, language, amenity).
               Índice GIN eliminado de hotels; índice B-Tree en hotels_amenities.amenity.

  STRUCT-006 : HotelPolicy — nueva tabla hotels_policies.
               hotels.policies (JSONB) eliminado.
               Cada política es un registro independiente con (hotel_id, url_id, language,
               policy_name, policy_details).

  STRUCT-007 : HotelLegal — nueva tabla hotels_legal.
               Almacena texto legal por hotel/idioma con campos legal, legal_info, legal_details.

  STRUCT-008 : HotelPopularService — nueva tabla hotels_popular_services.
               Lista de servicios más populares del hotel (curated subset de amenities).
