...
# ---------------------------------------------------------------------------
# API Export endpoints (Build 91 — STRUCT-EXPORT-002)
#
# Redesign: credenciales EXT_API_* centralizadas en .env / config.py.
# El usuario ya NO necesita pasar base_url ni api_key en cada llamada.
#
...
#   GET  /export/preview/{url_id}  → payload dry-run de un hotel (vista previa)
#   GET  /export/preview           → payload dry-run de todos los hoteles completados
#   POST /export/send/{url_id}     → enviar UN hotel a la API externa
#   POST /export/send              → enviar TODOS los hoteles completados a la API
# ---------------------------------------------------------------------------
