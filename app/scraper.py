# =============================================================================
# app/scraper.py — BookingScraper Pro v6.0.0 Build 72
# =============================================================================
...
class SeleniumEngine:
    ...
    def _clear_profile_singletons(self) -> None:
        """
        BUG-VPN-007-FIX (Build 72): Remove Chromium singleton lock files from
    ...
    def _get_driver(self) -> webdriver.Chrome:
        ...
        BUG-VPN-007-FIX (Build 72): clears Chromium singleton lock files
        before instantiation to prevent DevToolsActivePort errors after
        a browser reset triggered by VPN rotation.
        RULE-SINGLE-TAB (Build 72): enforces exactly one tab after init.
        """
        if self._driver is None:
