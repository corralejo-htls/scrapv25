# =============================================================================
# app/scraper.py — BookingScraper Pro v6.0.0 Build 63
# =============================================================================
...
class SeleniumEngine:
    ...
    def _fetch_with_selenium(
        ...
        Sequence:
          ...
          2. driver.get(url)
          3. Wait for hotel content to appear
          4. Language verification (mismatch → retry)
          5. Short HTML check (BUG-LANG-001 fast-fail)
          6. Gallery open + photo JS extraction
          7. Return final page_source
