# =============================================================================
# app/scraper.py — BookingScraper Pro v6.0.0 Build 106
# =============================================================================
...
class SeleniumEngine:
    ...
    def _fetch_with_selenium(
        ...
        with self._lock:
            ...
            # ── Build 109: captura del modal de galería (solo EN) ───────────
            # Las fotos son language-independent; la clasificación se hace una
            # sola vez en el pase EN para no multiplicar el coste por idioma.
