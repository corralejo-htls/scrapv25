"""
BookingScraper Pro v6.0.0 build 104
Platform: Windows 11 + Python 3.14.x

Cambios build 104:

  BUG-CAT-SPACE-001-FIX: extractor.py — _normalize_category_heading().
    Root cause: div.get_text() concatenaba nombre de categoría con badge
    "Free!" (y variantes por idioma) sin espacio intermedio.
    Fix 1: get_text(separator=" ") en los 3 puntos de extracción de
    category_title en Strategy E45.
    Fix 2: Nuevo método @staticmethod _normalize_category_heading() con
    regex safety-net. Aplicado también en Strategy 1 y Strategy 1.5.
    Ver: BUG_REPORT_Build104_EN.md
