...
class HotelExtractor:
    ...
    def _extract_legal(self) -> Optional[Dict[str, str]]:
        ...
        selectors = [
            ...
            {"attrs": {"class": re.compile(r"legal.info|legal.text|legalinfo", re.I)}},
    ...
    def _extract_faqs(self) -> List[str]:
        """
        STRUCT-015 (v53): Extrae las preguntas frecuentes (FAQ) del hotel.

        Solo se almacena el texto de la pregunta (campo ask).
        Una pregunta por fila en hotels_faqs.
        ...
        Retorna: lista de strings (texto de pregunta), deduplicados.
        """
        faqs: List[str] = []
        seen: set = set()
        ...
        if section:
            ...
            try:
                # Patrón 1: botones de accordion (texto que contiene "?")
