"""
extractor.py — BookingScraper Pro v6.0.0 build 51
==================================================
Cambios v51:
...
class HotelExtractor:
    ...
    def _extract_legal(self) -> Optional[Dict[str, str]]:
        ...
        # Intento 2: buscar por texto del título
        if not section:
            try:
        ...
        try:
            ...
            # Texto principal — primer párrafo/div de texto
            ...
            # Si los párrafos no están separados, tomar el texto del bloque entero
            if not legal_info:
                if title_el:
                    title_el.extract()
            ...
            logger.debug("Legal section extracted for lang=%s: %d chars", self.language, len(legal_info))
            return result
