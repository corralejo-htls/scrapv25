"""
extractor.py — BookingScraper Pro v6.0.0 Build 99
==================================================
...
class HotelExtractor:
    ...
    # Mapa de inferencia de categoría por substrings para servicios que
    # provienen de estrategias sin grupo DOM (Strategy 1-flat, 2, 3).
    # Orden: más específico primero. Primera coincidencia gana.
    # groupId referencia _FACILITY_GROUP_MAP para traducción dinámica.
    # =========================================================================
    _SERVICE_CATEGORY_RULES: List[Tuple[Tuple[str, ...], int]] = [
        # ── Food & Drink (groupId=7) ─────────────────────────────────────────
        (("breakfast", "desayuno", "colazione", "petit-déjeuner",
          "frühstück", "pequeno-almoço"), 7),

        # ── Outdoors & View (groupId=13) ─────────────────────────────────────
        (("outdoor furniture", "gartenmöbel", "muebles de exterior",
          "mobilier d'extérieur", "mobilier d\u2019ext\u00e9rieur", "mobiliário de exterior",
          "arredamento da esterno", "sea view", "meerblick",
          "vista mar", "vista mare", "vue sur la mer", "vistas al mar",
          "view", "vista", "vistas", "aussicht", "vue"), 13),

        # ── Services / Staff languages (groupId=3) ───────────────────────────
        (("wake-up service", "servicio de despertador", "sveglia telefonica",
          "service de réveil", "weckservice", "serviço de despertar",
          "english", "inglés", "inglese", "anglais", "englisch", "inglês"), 3),
        ...
        (("non-smoking", "prohibido fumar", "struttura interamente non fumatori",
          ...
          "proibido fumar", "hypoallergenic", "hipoalergénico", "antialérgico",
