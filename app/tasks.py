"""
tasks.py — BookingScraper Pro v6.0.0 build 120
Build 120:
...
def scrape_pending_urls(self) -> dict:
    ...
    try:
        ...
        # BUG-TASK-HANG-001-FIX: cancelar watchdog antes de liberar el lock.
        # Si el batch completó (incluso con error), el watchdog ya no debe disparar.
        _watchdog_fired.set()
        _watchdog.cancel()
