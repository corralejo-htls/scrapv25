# =============================================================================
# app/scraper_service.py — BookingScraper Pro v6.0.0 Build 78
# =============================================================================
...
class ScraperService:
    ...
    def _upsert_hotel_all_services(
        ...
        all_services = List[str] — una fila por servicio.
        """
        from app.models import HotelAllService
        services: list = data.get("all_services") or []
        now = _now()
        for svc in services:
            if not svc or not isinstance(svc, str):
                continue
    ...
    def _upsert_hotel_nearby_places(
        ...
        nearby_places = List[Dict] con 'place_name', 'distance', 'category'.
        Una fila por lugar.
        """
    ...
    def _upsert_hotel_room_types(
        ...
        room_types = List[Dict] con 'name', 'description', 'facilities'.
        Una fila por tipo de habitación. Complementa hotels.room_types (JSONB).
        """
