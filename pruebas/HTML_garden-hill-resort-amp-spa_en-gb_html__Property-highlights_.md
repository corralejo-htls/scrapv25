<HTML>
<!--
HTML_garden-hill-resort-amp-spa_en-gb_html__Property-highlights_.md
URL : https://www.booking.com/hotel/sc/garden-hill-resort-amp-spa.en-gb.html?lang=en-gb
SELECTOR : #basiclayout > div.hotelchars > div.page-section.hp--desc_highlights.js-k2-hp--block > div > div.bui-grid__column.bui-grid__column-4.k2-hp--highlights > div > div:nth-child(2) > div > div.ph-sections
FULL XPATH : /html/body/div[4]/div/div[5]/main/div[1]/div[3]/div/div[2]/div/div[2]/div/div[1]
parte HTML : Property highlights
note : Generate a new table called 'hotels_Strengths' with the fields (id, hotels.hotel_id, hotels.language, Strength). 
example :  (Strength : html (grabar HTML , excepto imagenes y los atributos de todas las etiquetas  HTML))
note : Save the HTML, except for image tags which are completely removed, such as <svg></svg>. - In other HTML tags such as <div> <p> <ul> <li>, remove all their attributes and values ​​such as class, height, width, aria-hidden, focusable, data, id, etc.
-->
...
<span class="ph-item-copy-top-location">Top location: Highly rated by recent guests (9.1)
</span>
</span>
</p>
</div>
...
<p class="ph-item">
<span class="ph-item-copy ">
<span class="ph-item-copy-breakfast-option">Continental, Vegetarian, Vegan, Buffet, Breakfast to go</span>
</span>
</p>
</div>
<div class="ph-section">
<ul class="bui-list bui-list--text ph-section-items">
<li class="bui-list__item ph-content " data-title="">
<p class="ph-item">
...
<span class="ph-item-copy ">
<span class="ph-item-copy-parking">Free private parking available on-site</span>
</span>
</p>
</li>
</ul>
...
<p class="ph-item">
<span class="ph-item-copy ">
<span class="ph-item-copy-activity-unknown">Fitness centre</span>
</span>
</p>
</li>
<li class="ph-content">
<p class="ph-item">
<span class="ph-item-copy ">
<span class="ph-item-copy-activity-unknown">Spa and wellness centre</span>
</span>
</p>
</li>
<li class="ph-content">
<p class="ph-item">
<span class="ph-item-copy ">
<span class="ph-item-copy-activity-unknown">Kids' club</span>
</span>
</p>
</li>
</ul>
