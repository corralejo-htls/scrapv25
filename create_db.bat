...
REM BookingScraper Pro v6.0.0 Build 96 | Windows 11
REM
...
ECHO ============================================================
ECHO  BookingScraper Pro v6.0.0 Build 96 - Creacion de Base de Datos
ECHO ============================================================
ECHO.
...
ECHO.
ECHO Base de datos creada correctamente con schema v77 (Build 96).
