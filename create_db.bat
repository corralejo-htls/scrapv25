...
ECHO ============================================================
ECHO  BookingScraper Pro v48 - Creacion de Base de Datos
ECHO ============================================================
ECHO.
...
ECHO Aplicando esquema completo (install_clean_v48.sql)...
psql -U %PGUSER% -h %PGHOST% -d bookingscraper -f install_clean_v48.sql
IF ERRORLEVEL 1 (
